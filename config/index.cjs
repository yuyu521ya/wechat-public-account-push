...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '芋芋', year: '2000', date: '04-17',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '星星', year: '2000', date: '12-01',
        },
        {
  ...
  CALLBACK_TEMPLATE_ID: 'orZU66zu4_MFedLF_ObPJVXTi1Ic',

  CALLBACK_USERS: [
    {
      name: '自己',
      // 使用微信测试号：自己的微信id，扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: 'orZU665n7ZreDccXgrLX4CfsmR1A',
    }
  ],
